...
const depthConfig:Record<ImpactDepth,DepthConfig>={
  ...
  deep:{label:"Approfondie",maxItems:24,maxUrls:24,corpusChars:52000,timeoutMs:58000,instruction:"NOTE APPROFONDIE. Produis un diagnostic stratégique de second niveau, nettement plus riche qu’une note Standard. Traite transversalement jusqu’à 24 évolutions de veille et utilise toutes leurs sources uniques disponibles. Croise les sources entre elles, distingue les faits établis des inférences, explique les mécanismes d’impact sur l’activité et l’objectif client, développe les dépendances et incertitudes, et justifie séparément les six critères du score. Les risques, opportunités, échéances et recommandations doivent être développés avec cause, mécanisme, conséquence, signal à surveiller et action opérationnelle lorsqu’ils sont étayés. Maximum 5 dispositions, 5 risques, 4 opportunités, 4 échéances et 6 recommandations."},
};
