...
export default function ChangesModuleV4({dossiers,watch}:{dossiers:Dossier[];watch:Watch[];onOpenImpact?:(dossierId:string,watchIds:string[])=>void}){
  ...
  return <div className="page"><style jsx>{`
    ...
    .detail{background:#091d38;border:1px solid rgba(255,255,255,.08);border-radius:13px;padding:14px 15px}.detail h4{font-size:12px;margin:0 0 7px}.detail p{font-size:10px;line-height:1.6;color:#c3cfdd;margin:0}.detailFoot{display:flex;gap:12px;flex-wrap:wrap;margin-top:10px}.detailFoot a{display:inline-flex;align-items:center;gap:5px;color:#ffd466;font-size:9px;font-weight:850;text-decoration:none}.objective{margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,.07);color:#aebed1;font-size:9px}
    .sourcesPanel{display:grid;gap:9px;background:#091f3d;border:1px solid rgba(255,255,255,.09);border-radius:15px;padding:15px}.sourcesHead span{display:block;color:#f3bd3e;font-size:9px;font-weight:950;text-transform:uppercase;letter-spacing:.08em}.sourcesHead p{margin:4px 0 0;color:#90a5bd;font-size:10px}.sourceRow{display:grid;grid-template-columns:120px minmax(0,1fr) auto;gap:12px;align-items:center;background:#0b294c;border:1px solid rgba(255,255,255,.08);border-radius:11px;padding:11px 12px}.sourceRow small{color:#8298b4;font-size:8px}.sourceRow strong{font-size:10px;line-height:1.35}.sourceRow a{display:inline-flex;align-items:center;gap:5px;color:#ffd466;font-size:9px;font-weight:850;text-decoration:none}.sourceCurrent{border-color:rgba(243,189,62,.45)}
    .empty{padding:35px;text-align:center;color:#8ea2ba;background:#0a203e;border-radius:15px}.emptyPage{padding:30px;background:#071936;color:#fff;border-radius:16px}
    @media(max-width:1050px){.scheme{grid-template-columns:1fr}.arrow{height:18px;transform:rotate(90deg)}}@media(max-width:700px){.page{padding:15px}.head{display:grid}.tabs{gap:14px;overflow-x:auto}.tabs button{white-space:nowrap}.filters{grid-template-columns:1fr}.changeHead{display:grid}.focusBox{grid-template-columns:auto 1fr}.focusBtn,.sourceBtn{grid-column:1/-1;justify-content:flex-start}.chainTop{display:grid}.sourceRow{grid-template-columns:1fr}}
  `}</style>
