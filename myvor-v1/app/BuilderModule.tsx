...
export default function BuilderModule({dossiers,watch}:{dossiers:Dossier[];watch:Watch[]}){
  ...
  return <div className={styles.page}>
    <header className={styles.head}><div><div className={styles.kicker}>Production opérationnelle</div><h1>Note Builder</h1><p>Transformez les analyses Myvor en livrables prêts à envoyer.</p></div><div className={styles.statusPill}>IA contextualisée · {reviewLabel(reviewStatus)}</div></header>
