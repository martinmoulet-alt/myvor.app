...
export type ImpactCandidate={item:WatchForImpact;confidence:number|null;reason:string;linked:boolean;source:"linked"|"live"|"persisted"};
...
export function buildImpactCandidates(allWatch:WatchForImpact[],dossierId:string,assignments:ImpactAssignment[]){
  ...
  return allWatch.map(item=>{
    ...
    return{item,confidence,reason,linked,source:linked?"linked":liveMatch?"live":"persisted"} as ImpactCandidate;
