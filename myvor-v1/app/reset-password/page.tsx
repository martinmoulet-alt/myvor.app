...
export default function ResetPasswordPage(){
  ...
  useEffect(()=>{
    if(!supabase){setMessage("Le service d’authentification est temporairement indisponible.");return;}
    let active=true;
    async function init(){
      try{
        ...
        else setMessage("Lien invalide ou expiré. Demandez un nouvel e-mail de récupération depuis l’écran de connexion.");
