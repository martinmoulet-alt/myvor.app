-- Fix dossier creation failures caused by the watch-item client guard.
-- Direct client mutations hit the watch_items guard at trigger depth 1.
-- Trusted server-side mutations emitted from another database trigger run at depth > 1.
