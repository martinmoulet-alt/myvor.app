-- Myvor migration — strict tenant isolation for V1 business data.
-- Assumes the V1 tables already exist. Idempotent on the current database.
...
-- PostgreSQL permissive policies are OR'ed together. Remove every prior policy
-- on these four business tables before rebuilding the ownership rules.
do $$
declare
